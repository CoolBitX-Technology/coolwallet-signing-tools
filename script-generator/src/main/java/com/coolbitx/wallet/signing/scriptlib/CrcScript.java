...
public class CrcScript {
    public static void listAll() {
        System.out.println("Crc Send: \n" + getCRCScript(CrcTxType.SEND) + "\n");
    }

    public enum CrcTxType {
    ...
    public static String getCRCScript(CrcTxType type){
